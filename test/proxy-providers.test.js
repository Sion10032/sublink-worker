...
describe('Auto Proxy Providers Detection', () => {
    ...
    describe('Clash Builder', () => {
        ...
        it('should parse and embed proxies when useProviders is false', async () => {
            // Mock fetchSubscriptionWithFormat to return Clash format
            fetchSubscriptionWithFormat.mockResolvedValue({
                content: mockClashYaml,
                format: 'clash',
            ...
            const builder = new ClashConfigBuilder(
                ...
                false // useProviders - DISABLED
            );
            const yamlText = await builder.build();
            const config = yaml.load(yamlText);

            // Should NOT have proxy-providers when useProviders is false
            ...
            // proxy-groups should NOT have 'use' field when useProviders is false
            const nodeSelect = config['proxy-groups'].find(g => g.name === '🚀 节点选择');
    ...
    describe('Sing-Box Builder', () => {
        ...
        it('should parse and embed proxies when useProviders is false', async () => {
            ...
            // Should NOT have outbound_providers when useProviders is false
            ...
            // outbounds should NOT have 'providers' field when useProviders is false
            const nodeSelect = config.outbounds.find(o => o.tag === '🚀 节点选择');
