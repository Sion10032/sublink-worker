    ...
    window.formData = function () {
        ...
        return {
            ...
            init() {
                ...
                this.useProviders = localStorage.getItem('useProviders') !== 'false';
                ...
                this.$watch('useProviders', val => localStorage.setItem('useProviders', val));
            ...
            async submitForm() {
                ...
                try {
                    ...
                    if (!this.useProviders) params.append('use_providers', 'false');
            ...
            populateFormFromUrl(url) {
                ...
                this.useProviders = params.get('use_providers') !== 'false';
                ...
                if (selectedRules || customRules || this.groupByCountry || this.enableClashUI || this.mergeUserGroups ||
