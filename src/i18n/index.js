...
export const translations = {
  'zh-CN': {
    ...
    useProviders: '使用 Providers',
    fileName: '文件名称',
    fileNamePlaceholder: '下载时使用的文件名（可选）',
  ...
  'en-US': {
    ...
    useProviders: 'Use Providers',
    fileName: 'File Name',
    fileNamePlaceholder: 'Filename to use when downloading (optional)',
  ...
  'fa': {
    ...
    useProviders: 'استفاده از Providers',
    fileName: 'نام فایل',
    fileNamePlaceholder: 'نام فایل برای استفاده هنگام دانلود (اختیاری)',
  ...
  'ru': {
    ...
    useProviders: 'Использовать Providers',
    fileName: 'Имя файла',
    fileNamePlaceholder: 'Имя файла при скачивании (необязательно)',
